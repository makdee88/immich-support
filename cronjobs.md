...
2-59/15 * * * * ping -c1 -W1 192.168.10.100 >/dev/null 2>&1 && curl -X POST -H "x-api-key: <IMMICH_API_KEY>" http://localhost:2283/api/libraries/630b44a8-5b0a-4b3d-82e0-58568934270c/scan >> /var/log/immich-scan.log 2>&1
